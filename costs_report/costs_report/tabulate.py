...
This file is copied directly from the "tabulate" library, which is
written by Sergey Astanin and used here under the MIT Licence.
Copying this file into the project is easier than setting up a whole
build process using pip.

https://github.com/astanin/python-tabulate/blob/b2c26bcb70e497f674b38aa7e29de12c0123708a/tabulate.py
